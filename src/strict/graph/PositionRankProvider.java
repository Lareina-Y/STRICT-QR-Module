...
public class PositionRankProvider {
    ...
    public PositionRankProvider(SimpleDirectedWeightedGraph<String, DefaultWeightedEdge> wgraph, HashMap<String, QueryToken> tokendb) {
    ...
    public HashMap<String, QueryToken> calculatePositionRank() {
        ...
        while (!enoughIteration) {
            ...
            for (String vertex : wgraph.vertexSet()) { // V_i
                double biasWeight = this.tokendb.get(vertex).positRankBiasWeight; //biasWeight_i
